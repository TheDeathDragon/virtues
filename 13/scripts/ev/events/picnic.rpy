label CDE_Picnic:
    ...
    narrator "I was waked by my phone in the morning. It was Aunt Elisa."
    ...
    player "Okay, Aunt Elisa. I will be there. "

    narrator "It's not a bad idea to go picnic with Aunt Elisa's family on the weekend. I mean, there will be 3 beautiful ladies around me. Which man would reject this?"

    narrator "... ... ... ..."

    scene cde_date1_1 with tstmgr

    narrator "Some time later, I arrived at the picnic camp. Aunt Elisa and her daughters were already there."

    d "[P]!"

    c "Why is he here, mom?"

    e "I invited [P] here. There has to be a man at the picnic."
    ...
    menu:
        "Theodora":
            ...
            e "Smart choice, never let your fiancee down."
        ...
        "Aunt Elisa":
            ...
            d "It must because of your dressing, mom! You cheat!"
    ...
    narrator "I mean, I don't have any sibling, nor a mother in my life. I didn't know how is it like to be with them until I met with Aunt Elisa's family. I really appreciate it."

    narrator "I would like to sit here and listen to their talking forever. It is just so warm."
    ...
    e "Glad to hear that. Theo may seem cold from outside, but I know that she cares about you very much from inside."
    ...
    menu:
        ...
        "I think you should stay with Aunt Elisa":
            ...
            d "Yes, you are. Otherwise why did you leave home and live at somewhere else?"
            scene cde_date1_30 with tstmgr
    ...
    e "Okay, clam down, kids. Who wants some sandwichs?"
    ...
    menu:
        "Warn her":
            ...
            narrator "I gave Theodora an eye contact. She seemed to realize it."
        ...
        "Don't warn her":
            ...
            d "Her nipples."
            narrator "She suddenly stuck her fingers in Theodora's breasts. It seems like she has found the right place of where Theodora's nipples are located. "
    ...
    narrator "Some time later. The sun is about to set."
