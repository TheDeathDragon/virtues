label C_train_inti_3:
    ...
    scene c_train_inti_3_2 with tstmgr
    ...
    scene c_train_inti_3_3 with tstmgr
    ...
    scene c_train_inti_3_4 with tstmgr
    ...
    scene c_train_inti_3_6 with tstmgr
    ...
    scene c_train_inti_3_16 with tstmgr
    ...
    scene c_train_inti_3_21 with tstmgr
    ...
    scene c_train_inti_3_34 with tstmgr
    ...
    scene c_train_inti_3_35 with tstmgr
    ...
    player "I mean, you ae my beloved wife~"
    ...
    scene c_train_inti_3_38 with tstmgr
    ...
    scene c_train_inti_3_42 with tstmgr
    ...
    scene c_train_inti_3_44 with tstmgr
    ...
    scene c_train_inti_3_46 with tstmgr

    pause



    scene c_train_inti_3_47 with tstmgr

    pause



    scene c_train_inti_3_48 with tstmgr

    pause



    scene c_train_inti_3_49 with tstmgr
    ...
    scene c_train_inti_3_50 with tstmgr
    play sound c_train_inti_3_50 loop
    pause



    c "Ohhhh~~ huuhhhhh~~~ [P]~~~ Eaaawwwww~~~ love~~~"
    ...
    stop sound
    scene c_train_inti_3_51 with tstmgr
    play sound c_train_inti_3_51 loop
    pause
    ...
    stop sound
    scene c_train_inti_3_52 with tstmgr
    play sound cumshot
    $ flashlight()

    c "Ohhhhhhhhhhhhhhhhhhhhhhhhhh!!!!~~~~~~~"
