label CDE_duo_6:
    ...
    e "Wmmmmmmm~~ hhhhuuhh~~ Yes... Ohh~~~~"



    scene cde_duo_6_1 with dissolve
    play sound cde_duo_6_1 loop
    pause
    ...
    stop sound
    scene cde_duo_6_2 with tstmgr
    play sound cde_duo_6_2 loop
    pause
    ...
    stop sound
    scene cde_duo_6_3 with tstmgr
    play sound cde_duo_6_3 loop
    pause
    ...
    stop sound
    scene cde_duo_6_5 with tstmgr
    play sound cde_duo_6_5 loop
    pause
    ...
    scene cde_duo_6_12 with tstmgr
    ...
    scene cde_duo_6_15 with tstmgr
    ...
    scene cde_duo_6_17 with dissolve

    d "Da-lah!~~~"



    scene cde_duo_6_18 with tstmgr
    ...
    scene cde_duo_6_21 with tstmgr
    ...
    scene cde_duo_6_23 with tstmgr
    ...
    scene cde_duo_6_25 with tstmgr
    ...
    scene cde_duo_6_28 with tstmgr
    ...
    scene cde_duo_6_29 with tstmgr
    ...
    scene cde_duo_6_30 with tstmgr
    play sound cde_duo_6_30 loop
    pause
    ...
    stop sound
    scene cde_duo_6_30 with flashback
    play sound cde_duo_6_30 loop
    pause
    ...
    stop sound
    scene cde_duo_6_31 with tstmgr
    play sound cde_duo_6_31 loop
    pause
    ...
    stop sound
    scene cde_duo_6_32 with tstmgr
    play sound cumshot
    $ flashlight()

    d "Yeeeeeeeeeeeeeeeee!!!~~~~~~~~"



    scene cde_duo_6_33 with tstmgr

    "Irene’s little body shook so hard while I injected my cum into his tender water-filled pussy~"
    ...
    scene cde_duo_6_34 with tstmgr

    pause



    scene cde_duo_6_35 with tstmgr

    pause



    scene cde_duo_6_36 with tstmgr

    $ flashlight()

    d "Awwwwwwwuuummm~~~ mmmmmmmm~~~ mmmm~~~~"
    ...
    d "Glug... ... gluug... ... glug... ... gluug... ..."



    scene cde_duo_6_37 with tstmgr
