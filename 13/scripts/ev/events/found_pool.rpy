label found_pool:
    ...
    scene found_pool_3 with flashback
    ...
    scene found_pool_8 with tstmgr
    ...
    scene found_pool_17 with tstmgr
    ...
    scene found_pool_18 with tstmgr
    ...
    scene found_pool_19 with tstmgr
    ...
    scene found_pool_20 with tstmgr
    ...
    scene found_pool_33 with tstmgr

    pause



    scene found_pool_34 with tstmgr
    ...
    scene found_pool_35 with tstmgr
    play sound found_pool_35 loop
    ...
    stop sound
    scene found_pool_36 with tstmgr
    play sound found_pool_36 loop
    ...
    scene found_pool_37 with tstmgr
    play sound cumshot
    $ flashlight()
