label D_train_sha_1:
    ...
    scene d_train_sha_1_3 with tstmgr
    ...
    scene d_train_sha_1_8 with tstmgr
    ...
    scene d_train_sha_1_15 with tstmgr

    d "Ohhhh~~~"



    scene d_train_sha_1_16 with tstmgr
    ...
    scene d_train_sha_1_18 with tstmgr
    ...
    scene d_train_sha_1_21 with tstmgr
    ...
    scene d_train_sha_1_24 with tstmgr
    ...
    scene d_train_sha_1_25 with tstmgr
    play sound d_train_sha_1_25 loop
    pause
    ...
    stop sound
    scene d_train_sha_1_26 with tstmgr
    play sound d_train_sha_1_26 loop
    pause
    ...
    scene d_train_sha_1_28 with tstmgr

    d "Wummmmmmmmmmmmmmmmmm!!!!!!!~~~~~"
    ...
    stop sound
    scene d_train_sha_1_33 with tstmgr
    play sound cumshot
    ...
    scene d_train_sha_1_32 with tstmgr
    ...
    scene d_train_sha_1_35 with tstmgr
