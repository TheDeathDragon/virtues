label G_daily_3:
    ...
    scene g_love_2_4 with dissolve
    pause

    scene g_love_2_5 with dissolve
    pause

    scene g_love_2_6 with dissolve
    pause

    scene g_love_2_7 with dissolve
    pause

    scene g_love_2_8 with dissolve
    pause

    scene g_love_2_9 with dissolve
    pause

    scene g_love_2_10 with dissolve
    pause
