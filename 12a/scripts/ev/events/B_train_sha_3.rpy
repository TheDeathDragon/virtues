label B_train_sha_3:
    ...
    "米娜女士""哦，等等，我不能再叫你'小姑娘'了.感谢[P]，你现在已经成为一个真正的女人，一个真正的成熟女人~"
    ...
    scene b_train_sha_3_6 with tstmgr
    ...
    scene b_train_sha_3_7 with tstmgr

    b "I was scared in the beginning, but he didn’t hurt me at all. He knew my limit between the pleasure and the pain... ..."
    ...
    scene b_train_sha_3_9 with tstmgr
    ...
    "米娜女士""别这样，亲爱的，作为一个成熟的女人，有时荒淫无度一点也不可耻."



    "米娜女士""事实上.......我认为你需要学会更淫荡一点.这可以成为你的一个武器~"
    ...
    "米娜女士" "是的，那个女孩真的是个尤物.她绝对可以成为一个威胁."
    ...
    "米娜女士""但进一步提高你的魅力，学习一两招，与狄奥多拉这样的西方女孩竞争，总是没有坏处的."
    ...
    "米娜女士""那个狄奥多拉的乳房比你大，她的行为也更狂野，看看她的穿衣风格就知道了.她每天都裸露着她的胸罩和半个乳房."



    scene b_train_sha_3_16 with tstmgr

    "米娜女士""她知道如何用她的淫荡作为武器来吸引男性.如果你不做好准备，她可能真的会比你得到更多[P]的青睐."
    ...
    "米娜女士" "为了与她竞争，你也需要学习她的技巧."



    scene b_train_sha_3_17 with tstmgr

    "米娜女士""别担心，女孩，妈妈把你带到这里了~我会教你我所知道的一切，以获得男人的心~"
    ...
    scene b_train_sha_3_27 with tstmgr
    ...
    "该死的，光是想象在我的卧室里会发生什么，就已经让我很兴奋了~非常感谢你，米娜女士!"
    ...
    scene b_train_sha_3_34 with tstmgr
    ...
    scene b_train_sha_3_41 with tstmgr
    ...
    scene b_train_sha_3_52 with tstmgr
    ...
    b "Wuuuuuuummmm~~~~ Yes~~ mmuuuuummmm~~"



    scene b_train_sha_3_54 with tstmgr
    ...
    scene b_train_sha_3_59 with dissolve
    play sound b_train_sha_3_59 loop
    pause
    ...
    stop sound
    scene b_train_sha_3_60 with tstmgr
    play sound b_train_sha_3_60 loop
    pause
    ...
    stop sound
    scene b_train_sha_3_61 with tstmgr
    play sound cumshot
    $ flashlight()
    ...
    scene b_train_sha_3_62 with tstmgr
    ...
    scene b_train_sha_3_64 with dissolve
    play sound b_train_sha_3_64 loop
    pause
    ...
    stop sound
    scene b_train_sha_3_65 with tstmgr
    play sound b_train_sha_3_65 loop
    pause
    ...
    stop sound
    scene b_train_sha_3_66 with tstmgr
    play sound cumshot
    $ flashlight()
