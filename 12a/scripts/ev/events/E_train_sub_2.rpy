label E_train_sub_2:
    ...
    scene e_train_sub_2_5 with dissolve
    ...
    scene e_train_sub_2_9 with tstmgr
    ...
    scene e_train_sub_2_20 with tstmgr
    ...
    menu:
        "把奶吸出来":
            ...
            scene e_train_sub_2_26 with tstmgr
    ...
    scene e_train_sub_2_42 with tstmgr

    e "Wuuuuummmmmm~~~~~~"



    e "[P]~~ Wuuuummm~~ huuummm~~~"
    ...
    scene e_train_sub_2_48 with tstmgr
    ...
    scene e_train_sub_2_52 with tstmgr
    play sound e_train_sub_2_52 loop
    pause
    ...
    stop sound
    scene e_train_sub_2_53 with tstmgr
    play sound e_train_sub_2_53 loop
    pause



    e "Awwwwww~~~ wwwwwww~~~ oooooooowwwww~~~~"
    ...
    scene e_train_sub_2_54 with tstmgr
    play sound cumshot

    $ flashlight()

    e "Oooooohhhhhhhhhhhhhh!!!!!~~~~~~~~~"
    ...
    scene e_train_sub_2_56 with tstmgr

    play sound cumshot

    $ flashlight()

    e "Ahhhhhhhhhooooohhhhhhhh!!!!!!~~~~~~~~~"
