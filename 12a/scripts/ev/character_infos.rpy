...
define P_study = Progress("study", "Study", "B_love_meter", base=6.0, nz="森柠")
define P_work = Progress("work", "工作", "C_love_meter", base=6.0, nz="狄奥多拉")

define P_sport = Progress("sport", "Sport", "F_love_meter", base=6.0, nz="瑞秋")

define P = Player("P", state="P_state", color=color.cream)

default P_state = PlayerState(cash=500000.0)

define A_love = TrueLove("A_love_meter", max_value=50)
define B_love = TrueLove("B_love_meter", max_value=55)
define C_love = TrueLove("C_love_meter", max_value=60)
define D_love = TrueLove("D_love_meter", max_value=55)
define E_love = TrueLove("E_love_meter", max_value=55)
define F_love = TrueLove("F_love_meter", max_value=35)
define G_love = TrueLove("G_love_meter", max_value=55)
...
define A_harem = Harem("A_harem_meter", max_value=20)
define B_harem = Harem("B_harem_meter", max_value=15)
define C_harem = Harem("C_harem_meter", max_value=20)
define D_harem = Harem("D_harem_meter", max_value=15)
define E_harem = Harem("E_harem_meter", max_value=15)
define F_harem = Harem("F_harem_meter", max_value=10)
define G_harem = Harem("G_harem_meter", max_value=20)
