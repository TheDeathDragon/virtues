define past_note_link_text = "{a=past}v10: ...{/a}"

define update_note_text = '''{size=+2}{color=#ffcd5c}    We have rollbacked the version of RenPy engine from 7.4.2 to 7.3.5 in this update since 7.4.2 is an unstable version and we don't dare to try 7.4.3, the latest version, before it is proven stable by the majority. The rollback of engine version may causes some saves-loading problem. If you have any issues in loading your saves, please let us know.
And feel free to tell us if you find any other bugs or issues.
...
define past_update_note_text = '''v10:
