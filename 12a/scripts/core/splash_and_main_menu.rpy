...
screen main_menu():
    ...
    fixed at pause_emerge(0.5):
        ...
        frame:
            ...
            textbutton _("加群") action OpenURL ("https://jq.qq.com/?_wv=1027&k=m08FeHqo")
            ...
            if _in_replay:
                ...
                textbutton _("结束播放") action EndReplay(confirm=True)

            elif not main_menu:

                textbutton _("主菜单") action MainMenu()

            textbutton _("设置") action ShowMenu("about")
