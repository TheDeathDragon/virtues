...
define C_love = TrueLove("C_love_meter", max_value=75)
define D_love = TrueLove("D_love_meter", max_value=65)
define E_love = TrueLove("E_love_meter", max_value=65)
...
define B_harem = Harem("B_harem_meter", max_value=20)
