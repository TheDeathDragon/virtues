label E_train_sha_2:
    ...
    scene e_train_sha_2_15 with tstmgr

    pause



    scene e_train_sha_2_16 with tstmgr
    ...
    scene e_train_sha_2_19 with tstmgr
    ...
    scene e_train_sha_2_24 with dissolve
    play sound e_train_sha_2_24 loop
    pause
    ...
    stop sound
    scene e_train_sha_2_25 with tstmgr
    play sound e_train_sha_2_25 loop
    pause
    ...
    player "你身体的每一寸......都属于我.我有权利盯着我自己的东西看."
    ...
    stop sound
    scene e_train_sha_2_26 with tstmgr
    play sound cumshot
    $ flashlight()
    ...
    scene e_train_sha_2_32 with tstmgr
    ...
    scene e_train_sha_2_33 with dissolve
    play sound e_train_sha_2_33 loop
    pause
    ...
    stop sound
    scene e_train_sha_2_34 with tstmgr
    play sound e_train_sha_2_34 loop
    pause
    ...
    stop sound
    scene e_train_sha_2_36 with tstmgr
    play sound cumshot
    $ flashlight()

    e "Ahhhhhhhhhhhhhhhhhhhhhhhhhh!~~~~~~~~~"
    ...
    scene e_train_sha_2_35 with dissolve
