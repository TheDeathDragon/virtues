label CDE_duo_9:
    ...
    scene cde_duo_9_7 with dissolve
    ...
    scene cde_duo_9_10 with tstmgr
    ...
    scene cde_duo_9_25 with tstmgr
    ...
    scene cde_duo_9_31 with tstmgr

    pause



    scene cde_duo_9_32 with tstmgr
    ...
    scene cde_duo_9_33 with tstmgr

    player "Ahhhhhhh~~~~ This feels so goooood~~~~"
    ...
    scene cde_duo_9_40 with dissolve
    ...
    scene cde_duo_9_43 with tstmgr
    ...
    scene cde_duo_9_45 with tstmgr
    ...
    scene cde_duo_9_46 with tstmgr
    ...
    scene cde_duo_9_48 with tstmgr
    play sound cumshot
    $ flashlight()

    c "Owwwwwwwwuuummmmmm!!!!~~~~~~~"
