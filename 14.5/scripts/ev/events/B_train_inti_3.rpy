label B_train_inti_3:
    ...
    scene b_train_inti_3_5 with tstmgr
    ...
    scene b_train_inti_3_23 with tstmgr
    ...
    scene b_train_inti_3_31 with tstmgr

    pause



    scene b_train_inti_3_30 with tstmgr
    play sound spank
    $ flashlight()
    ...
    scene b_train_inti_3_52 with tstmgr

    pause

    scene b_train_inti_3_53 with tstmgr

    pause

    scene b_train_inti_3_54 with tstmgr
    ...
    scene b_train_inti_3_57 with tstmgr
    ...
    stop sound
    scene b_train_inti_3_44 with tstmgr
    play sound b_train_inti_3_44 loop
    pause
    ...
    stop sound
    scene b_train_inti_3_47 with tstmgr
    play sound b_train_inti_3_47 loop
    $ flashlight()
    ...
    stop sound
    scene b_train_inti_3_48 with tstmgr
    play sound b_train_inti_3_48 loop
    pause
    ...
    stop sound
    scene b_train_inti_3_49 with tstmgr
    play sound cumshot
    $ flashlight()

    b "Ohhhhhhhhhhhhhhhhhhhh!~~~~~~"
