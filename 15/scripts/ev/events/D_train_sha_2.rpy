label D_train_sha_2:
    ...
    scene d_train_sha_2_8 with tstmgr
    ...
    scene d_train_sha_2_10 with tstmgr

    pause



    scene d_train_sha_2_11 with tstmgr
    ...
    scene d_train_sha_2_24 with tstmgr
    ...
    scene d_train_sha_2_29 with tstmgr
    ...
    scene d_train_sha_2_30 with dissolve
    ...
    scene d_train_sha_2_31 with tstmgr
    ...
    scene d_train_sha_2_32 with tstmgr
    ...
    scene d_train_sha_2_33 with tstmgr
    play sound cumshot
    $ flashlight()
    ...
    scene d_train_sha_2_37 with tstmgr
    play sound cumshot
    $ flashlight()
    ...
    scene d_train_sha_2_39 with tstmgr
    play sound d_train_sha_2_39 loop
    $ flashlight()
    ...
    stop sound
    scene d_train_sha_2_40 with tstmgr
    play sound d_train_sha_2_40 loop
    pause



    d "Ahhh~~ yaaaah~~~ no~~ awww~~ [P]~~~ love~~~"
    ...
    stop sound
    scene d_train_sha_2_41 with tstmgr
    play sound cumshot
    $ flashlight()

    d "Aaaaaahhhhhhhhhhhhhhhh!!!!~~~~~~~"
