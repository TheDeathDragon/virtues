label G_train_sexskill_1:
    ...
    scene g_train_sexskill_1_1 with dissolve
    ...
    scene g_train_sexskill_1_3 with tstmgr

    player "Hmmmmm?"



    scene g_train_sexskill_1_4 with tstmgr
    ...
    scene g_train_sexskill_1_8 with tstmgr

    g "Uh-huh... ... ... ..."



    scene g_train_sexskill_1_7 with tstmgr
    ...
    scene g_train_sexskill_1_10 with tstmgr

    pause



    scene g_train_sexskill_1_11 with tstmgr
    ...
    scene g_train_sexskill_1_12 with tstmgr
    ...
    scene g_train_sexskill_1_13 with tstmgr
    ...
    scene g_train_sexskill_1_14 with tstmgr
    ...
    scene g_train_sexskill_1_16 with tstmgr
    play sound g_train_sexskill_1_16 loop
    pause
    ...
    stop sound
    scene g_train_sexskill_1_17 with tstmgr
    play sound g_train_sexskill_1_17 loop
    pause
    ...
    stop sound
    scene g_train_sexskill_1_18 with tstmgr
    play sound cumshot
    $ flashlight()
    ...
    scene g_train_sexskill_1_19 with tstmgr
    ...
    scene g_train_sexskill_1_25 with tstmgr
