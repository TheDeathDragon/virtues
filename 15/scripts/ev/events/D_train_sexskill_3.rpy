label D_train_sexskill_3:
    ...
    scene d_train_sexskill_3_1 with tstmgr
    ...
    scene d_train_sexskill_3_2 with tstmgr
    ...
    scene d_train_sexskill_3_3 with tstmgr
    ...
    scene d_train_sexskill_3_8 with tstmgr
    ...
    scene d_train_sexskill_3_13 with tstmgr
    ...
    scene d_train_sexskill_3_16 with tstmgr
    ...
    scene d_train_sexskill_3_17 with dissolve
    play sound d_train_sexskill_3_17 loop
    pause
    ...
    stop sound
    scene d_train_sexskill_3_18 with tstmgr
    play sound d_train_sexskill_3_18 loop
    pause
    ...
    stop sound
    scene d_train_sexskill_3_19 with tstmgr
    play sound d_train_sexskill_3_19 loop
    pause
    ...
    stop sound
    scene d_train_sexskill_3_20 with tstmgr
    play sound cumshot
    $ flashlight()
    ...
    scene d_train_sexskill_3_22 with tstmgr
