label CE_duo_1:
    ...
    scene ce_duo_1_33 with tstmgr
    play sound ce_duo_1_33 loop
    pause
    ...
    stop sound
    scene ce_duo_1_34 with tstmgr
    play sound ce_duo_1_34 loop
    pause
