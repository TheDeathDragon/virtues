label B_final_1:
    ...
    scene bm_duo_1_1 with dissolve
    ...
    scene bm_duo_1_32 with dissolve
    play sound bm_duo_1_32 loop
    pause
    ...
    stop sound
    scene bm_duo_1_33 with tstmgr
    play sound bm_duo_1_33 loop
    pause
