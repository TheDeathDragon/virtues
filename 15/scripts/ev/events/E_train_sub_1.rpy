label E_train_sub_1:
    ...
    scene e_train_sub_1_19 with tstmgr
    ...
    scene e_train_sub_24 with dissolve
    play sound e_train_sub_24 loop
    pause
    ...
    stop sound
    scene e_train_sub_25 with tstmgr
    play sound cumshot
    $ flashlight()
    ...
    scene e_train_sub_28 with tstmgr
    play sound e_train_sub_28 loop
    pause



    e "Owww~~ yes~~~ ahhh~~~~ uuhhhh~~~"
    ...
    stop sound
    scene e_train_sub_30 with tstmgr
    play sound cumshot
    $ flashlight()
    ...
    scene e_train_sub_32 with tstmgr
    play sound cumshot
    $ flashlight()
