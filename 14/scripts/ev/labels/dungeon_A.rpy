...
label dungeon_A.a_dungeon_1:
    ...
    scene a_dungeon_1_5 with tstmgr
    ...
    scene a_dungeon_1_6 with tstmgr
    ...
    scene a_dungeon_1_7 with tstmgr
    play sound cumshot
    $ flashlight()

    a "Ohhhhhhhhhhhhhhhhhhhhh!!~~~~~~~~~"
...
label dungeon_A.a_dungeon_2:
    ...
    scene a_dungeon_2_3 with tstmgr
    play sound a_dungeon_2_3 loop
    pause
    ...
    stop sound
    scene a_dungeon_2_4 with tstmgr
    play sound a_dungeon_2_4 loop
    pause
    ...
    stop sound
    scene a_dungeon_2_5 with tstmgr
    play sound cumshot
    $ flashlight()
