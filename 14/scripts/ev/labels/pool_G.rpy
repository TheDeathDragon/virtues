...
label pool_G.g_pool_1:
    ...
    scene g_pool_1_11 with tstmgr

    pause



    scene g_pool_1_12 with tstmgr
...
label pool_G.g_pool_2:
    ...
    scene g_pool_2_6 with tstmgr

    pause



    scene g_pool_2_7 with tstmgr
