label AB_duo_2:
    ...
    scene ab_duo_2_36 with tstmgr
    play sound ab_duo_2_36 loop
    $ flashlight()
    ...
    stop sound
    scene ab_duo_2_37 with tstmgr
    play sound ab_duo_2_37 loop
    pause
    ...
    scene ab_duo_2_40 with dissolve
