label CDE_duo_7:
    ...
    scene cde_duo_7_1 with dissolve
    ...
    scene cde_duo_7_10 with tstmgr
    ...
    scene cde_duo_7_13 with tstmgr

    $ flashlight()

    e "Ohhhhhhhhhhhhhhhhhhhhh!!!!~~~~~~~"
    ...
    scene cde_duo_7_14 with tstmgr
    play sound cumshot
    $ flashlight()
    ...
    scene cde_duo_7_15 with tstmgr
    play sound cumshot
    $ flashlight()
