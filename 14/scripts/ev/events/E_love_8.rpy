label E_love_8:
    ...
    scene e_love_6_19 with flashback
    ...
    scene e_love_8_55 with tstmgr

    e "[P]~~"



    scene e_love_8_56 with tstmgr
    ...
    scene e_love_8_61 with tstmgr
    play sound e_love_8_61 loop
    pause
    ...
    stop sound
    scene e_love_8_62 with tstmgr
    play sound e_love_8_62 loop
    pause
