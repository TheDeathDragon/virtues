label A_love_2_bLine:
    ...
    "Woman" "I didn' mean to do that, but you really should go find a better job. See, this is a city of opportunities. Although you have no education background, at least you have a pretty face. You know what I'm saying? If you want, you can always use that to earn a living."
    ...
    menu:
        "Pretend Vera is a social elite":
            ...
            player "You need to behave yourself and stop pretending like someone else. My dad won't be in the company for the next a few months, and there will be a lot of things waiting for you to deal with. You have no time to play with your weird habit."
            ...
            narrator "[P] drew me aside, but I am still confusing about what's going on."
            ...
            narrator "\"Keep silence and stay rude.\" That is what [P] told me to do. "
