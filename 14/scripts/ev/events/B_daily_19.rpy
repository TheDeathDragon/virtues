label B_daily_19:
    ...
    scene b_daily19_11 with tstmgr

    pause



    scene b_daily19_12 with tstmgr

    pause



    scene b_daily19_13 with tstmgr

    pause



    scene b_daily19_14 with tstmgr
    ...
    scene b_daily19_15 with tstmgr
    ...
    scene b_daily19_19 with tstmgr
    ...
    scene b_daily19_24 with tstmgr

    b "Awwwwwwwwwwwww... ... ... ..."



    scene b_daily19_25 with tstmgr

    "... ... ... ..."



    scene b_daily19_26 with tstmgr
    ...
    scene b_daily19_33 with tstmgr
    ...
    scene b_daily19_34 with tstmgr

    $ flashlight()

    b "Meeeeeeeeeeeaaaaaaannnnnn!!!!!~~~~~~"
    ...
    scene b_daily19_35 with tstmgr
    play sound b_daily19_35 loop
    pause
    ...
    stop sound
    scene b_daily19_37 with tstmgr
    play sound cumshot
    $ flashlight()

    b "Ohhhhhhhhhhhhhhhhh!!!!!~~~~"
    ...
    scene b_daily19_39 with tstmgr
    play sound b_daily19_39 loop
    pause
    ...
    scene b_daily19_40 with tstmgr

    play sound cumshot

    $ flashlight()

    b "Ohhhhhhhhhhhh~~~ (Ohhhhhhhhhhhh~~~:)"
