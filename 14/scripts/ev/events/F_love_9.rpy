label F_love_9:
    ...
    scene f_love_9_37 with tstmgr

    f "Hmmmm?"



    scene f_love_9_38 with tstmgr

    pause



    scene f_love_9_39 with tstmgr

    pause



    scene f_love_9_40 with tstmgr
    ...
    scene f_love_9_42 with tstmgr

    f "[P]... wuuuum~~~ ah~ mmmmmm~~~"



    scene f_love_9_43 with tstmgr

    f "Huuumm~~~ mmmmm~~ awwwwmmmmm... ..."
    ...
    f "Awwuumm~~~ wuummm~ mmm~~ mmm~ hummm~~"
    ...
    scene f_love_9_56 with tstmgr

    pause



    scene f_love_9_57 with tstmgr
    ...
    scene f_love_9_48 with tstmgr
    play sound f_love_9_48 loop
    pause
    ...
    stop sound
    scene f_love_9_49 with tstmgr
    play sound f_love_9_49
    pause
    ...
    stop sound
    scene f_love_9_60 with tstmgr
    play sound cumshot
    $ flashlight()

    f "Ohhhhhhhhhhhhhhhhhhhhh!~~~~~~"
