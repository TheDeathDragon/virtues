label B_action_sha_1:
    ...
    scene b_action_sha_1_1 with tstmgr
    ...
    label B_action_sha_1_choice_1:

    menu:
        "Go to the restroom with her":
            ...
            scene b_action_sha_1_15 with tstmgr

            $ flashlight()

            pause

            scene b_action_sha_1_16 with tstmgr
        ...
        "Stay with her here":
            ...
            b "I still can’t believe I’m witnessing a sex right now... ..."

            b "They looked... so enjoyed... ..."

            player "Sex is indeed something that can make people enjoyed~"

            player "You know, we should probably do the same thing as them~"
            ...
            "She didn’t resist when I put my hand on her breast. I guess what happened at the other table has increased her courage."
